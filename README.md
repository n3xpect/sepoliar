...
The [Google Cloud Web3 Faucet](https://cloud.google.com/application/web3/faucet/ethereum/sepolia) is a Sepolia testnet faucet that grants **0.05 ETH** or **100 PYUSD** per request and requires a Google account sign-in with a 24-hour cooldown. sepoliar automates the claim process: it saves encrypted Google sessions via Playwright, runs the claim cycle across multiple wallet addresses and token types, and reports results via Telegram.
